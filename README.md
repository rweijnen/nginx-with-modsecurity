...
NGINX <!--NGINX_VERSION-->1.29.6<!--NGINX_VERSION-->  
...
Built: <!--BUILD_DATE-->2026-03-11 00:00 UTC<!--BUILD_DATE-->  
Reason: <!--BUILD_REASON-->NGINX updated from 1.29.5 to 1.29.6<!--BUILD_REASON-->
