...
NGINX <!--NGINX_VERSION-->1.29.7<!--NGINX_VERSION-->  
...
Built: <!--BUILD_DATE-->2026-03-29 00:01 UTC<!--BUILD_DATE-->  
Reason: <!--BUILD_REASON-->OWASP CRS updated from v4.24.1 to v4.25.0<!--BUILD_REASON-->
